...
{
	uint16_t defaultValue = 0x001A;
	Register::SoftwareRegister<uint16_t> testedRegister( "DefaultValueTest1", defaultValue );
...
TEST_F( SoftwareRegisterTest, defaultValueTest2 )
{
	...
	Register::SoftwareRegister<uint16_t> testedRegister( "DefaultValueTest2" );
...
TEST_F( SoftwareRegisterTest, clearBitsTest1 )
{
	...
	Register::SoftwareRegister<uint16_t> testedRegister( "ClearBitsTest1", defaultValue );
...
TEST_F( SoftwareRegisterTest, clearBitsTest2 )
{
	...
	Register::SoftwareRegister<uint16_t> testedRegister( "ClearBitsTest2", defaultValue );
...
{
	uint16_t defaultValue = 0x242B;
	Register::SoftwareRegister<uint16_t> testedRegister( "ClearBitsTest3", defaultValue );
...
{
	uint16_t defaultValue = 0x242B;
	Register::SoftwareRegister<uint16_t> testedRegister( "SetBitsTest1", defaultValue );
...
TEST_F( SoftwareRegisterTest, setBitsTest2 )
{
	...
	Register::SoftwareRegister<uint16_t> testedRegister( "SetBitsTest2", defaultValue );
...
TEST_F( SoftwareRegisterTest, setBitsTest3 )
{
	...
	Register::SoftwareRegister<uint16_t> testedRegister( "SetBitsTest3", defaultValue );
...
TEST_F( SoftwareRegisterTest, insertTest1 )
{
	...
	Register::SoftwareRegister<uint32_t> testedRegister( "InsertTest1", defaultValue );
...
{
	uint32_t defaultValue = 0x5060E0D0;
	Register::SoftwareRegister<uint32_t> testedRegister( "InsertTest2", defaultValue );
...
{
	uint32_t defaultValue = 0x5060E0D0;
	Register::SoftwareRegister<uint32_t> testedRegister( "InsertTest3", defaultValue );
...
{
	uint32_t defaultValue = 0x5060E0D0;
	Register::SoftwareRegister<uint32_t> testedRegister( "CheckBitsTest1", defaultValue );
...
{
	uint32_t defaultValue = 0x5060E0D0;
	Register::SoftwareRegister<uint32_t> testedRegister( "CheckBitsTest2", defaultValue );
...
{
	uint32_t defaultValue = 0x5060E0D0;
	Register::SoftwareRegister<uint32_t> testedRegister( "CheckBitsTest3", defaultValue );
...
{
	uint32_t defaultValue = 0x5060E0D0;
	Register::SoftwareRegister<uint32_t> testedRegister( "CheckBitsTest4", defaultValue );
...
TEST_F( SoftwareRegisterTest, checkBitsTest5 )
{
	...
	Register::SoftwareRegister<uint32_t> testedRegister( "CheckBitsTest5", defaultValue );
