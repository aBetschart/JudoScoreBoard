...
{
    Register::HwRegister<uint32_t>* pllF0Reg    = new (reinterpret_cast<void*>( 0x400FE160 )) Register::HwRegister<uint32_t>;
...
{
    Register::HwRegister<uint32_t>* pllF1Reg    = new (reinterpret_cast<void*>( 0x400FE164 )) Register::HwRegister<uint32_t>;
